...
def run_tracker(tracker_name, tracker_param, run_id=None, dataset_name='otb', sequence=None, debug=0, threads=0,
                visdom_info=None, tracker_descrip=None, ckpt_num=None):
    ...
    trackers = [Tracker(tracker_name, tracker_param, run_id, dataset_name, tracker_descrip=tracker_descrip, checkpoint_num=ckpt_num)]
...
def main():
    ...
    parser.add_argument('--descrip', type=str, default='default')
    parser.add_argument('--checkpoint_num', '-ckpt', type=int, default=None, help='checkpoint number')
    ...
    for i in range(0,args.run_times):
        run_tracker(args.tracker_name, args.tracker_param, args.runid+i, args.dataset_name, seq_name, args.debug,
                    args.threads, {'use_visdom': args.use_visdom, 'server': args.visdom_server, 'port': args.visdom_port}, tracker_descrip= args.descrip, ckpt_num=args.checkpoint_num)


if __name__ == '__main__':
    main()

#---you may use the following command to run your tracker
